  ...
  return (
    ...
    >
      <div className="md:flex items-center justify-center gap-10 w-[90%] m-auto py-20">
        <div className="xl:bg-[#F6F6F3] dark:bg-[#2A2A28] rounded-2xl xl:p-6 transition-colors duration-700 2xl:w-[671px]">
          ...
          <div className="flex lg:flex md:block items-center gap-4 items-cente ">
            ...
            <div className=" text-gray-800 dark:text-gray-300 ">
              ...
              <p className=" mt-2 tracking-tight leading-[1.3] dark:text-gray-300 xl:hidden">
                Whether it's designing intuitive mobile apps, landing pages, or
                high-impact social content, I bring a strategic and user-focused
                mindset to every project.
              </p>

          <p className="mt-8 italic text-gray-700 dark:text-gray-300">
