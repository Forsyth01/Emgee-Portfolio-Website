...
const Experience = () => {
  return (
    <div className="bg-white dark:bg-[#1A1A19] py-20">
      <div className="sm:w-[85%] m-auto flex justify-center items-center sm:py-10 p-6 bg-white dark:bg-[#222221] dark:rounded-2xl transition-colors duration-300">
